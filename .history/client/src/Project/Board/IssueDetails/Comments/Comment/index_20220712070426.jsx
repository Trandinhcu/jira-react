      ...
      <Content>
        ...
        {isFormOpen ? (
          ...
          <Fragment>
            ...
            <EditLink onClick={() => setFormOpen(true)}>Chỉnh sửa</EditLink>
            <ConfirmModal
              title="Bạn có chắc muốn xóa bình luận này?"
              message="Sau khi bạn xóa, nó sẽ biến mất"
              confirmText="Xóa bình luận"
              onConfirm={handleCommentDelete}
              renderLink={modal => <DeleteLink onClick={modal.open}>Xóa</DeleteLink>}
            />
          </Fragment>
        )}
      </Content>
